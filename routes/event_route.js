...
router.post('/deleteRecentEvent',passport.authenticate('jwt', { session: false }),eventController.deleteRecentEvent);
router.get('/fetchRecentEvent', eventController.fetchRecentEvent);
